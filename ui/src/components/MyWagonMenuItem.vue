<template>
  <div class="container">
    ...
    <div class="panel">
      <div class="panel-title" @click="[SelectWagon(), Expand()]">
        <h6 class="grey-text plus">
          <span
            class="material-icons center active-wagon mr"
            v-if="isActive"
          >&#xe5cb;</span>
          {{ label }}
          <span
            class="material-icons center active-wagon ml"
            v-if="isActive"
          >&#xe5cc;</span>
        </h6>
      </div>
    ...
    <div v-if="isOpen" class="mb">
      <div></div>
      <!--  -->
      <div class="panel-mywagon item">
        <button class="item-mywagon" @click="RenameWagon()">{{ $store.getters.getTranslation('renamePersonalWagon') }}</button>
        <button class="item-mywagon" @click="SpawnData()">{{ $store.getters.getTranslation('spawnPersonalWagon') }}</button>
        <button class="item-mywagon" @click="toggleModal">{{ $store.getters.getTranslation('sellPersonalWagon') }}</button>
      </div>
      <!--  -->
      <div class=""></div>
    </div>
